...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.FileHolder> {
    ...
    public static class FileHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(DownloadFile file, int position)
        {
            ...
            int colorSuccess = ContextCompat.getColor(icon.getContext(), R.color.black);
            int colorFail = ContextCompat.getColor(icon.getContext(), R.color.purple_200);
            int colorWaiting = ContextCompat.getColor(icon.getContext(), R.color.purple_200);
